...
function get_breadcrumb() {
  ...
  if (is_category() || is_single()) {
      ...
      if ($post->post_parent) {
        if (get_post($post->post_parent)->post_parent) {
          echo "<span>&nbsp;&nbsp;/&nbsp;&nbsp;</span>";
          echo '<a href="'.get_permalink(get_post($post->post_parent)->post_parent).'" rel="nofollow">'.get_the_title(get_post($post->post_parent)->post_parent).'</a>';
        }
        echo "<span>&nbsp;&nbsp;/&nbsp;&nbsp;</span>";
      ...
      echo "<span>&nbsp;&nbsp;/&nbsp;&nbsp;</span> Wyniki wyszukiwania... ";
      echo '"<em>';
