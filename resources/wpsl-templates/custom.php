...
$output .= "\t\t\t\t" . '<select id="wpsl-search-input" value="' . apply_filters( 'wpsl_search_input', '' ) . '" name="wpsl-search-input" placeholder="" aria-required="true" >' . "\r\n";
$output .= '<option value="Miasto...">Miasto...</option>' . "\r\n";
if($cities) {
