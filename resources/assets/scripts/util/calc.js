...
var calc = function(formId, amountId, installmentId) {
  ...
  function calcMathSlider1() {
    ...
    slider1.noUiSlider.on('update', function() {
      ...
      document.getElementById('input_${formId}_${amountId}').setAttribute('value', parseInt(slider1.noUiSlider.get(), 10));
    });
  }
  ...
  function calcMathSlider2() {
    ...
    slider2.noUiSlider.on('update', function() {
      ...
      calcSum.innerHTML = Math.floor(installment);
      document.getElementById('input_${formId}_${installmentId}').setAttribute('value', parseInt(slider2.noUiSlider.get(), 10));
    });
  }
};
